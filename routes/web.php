...
Route::get("/chat/videocoference/{id}",["uses"=>"ChatController@videoConference","as"=>"videoConference"]);
Route::post('/pusher/auth',["uses"=>'ChatController@authenticate','as'=>'auth']);
