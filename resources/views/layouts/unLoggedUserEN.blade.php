...
<div class="flex-center full-height">
    <div class="header">
        <div class="row">
            @include('Frontend.pages.Frontend_Page.first_MenuEN')
        </div>
    </div>
    <div class="main">
        <div class="row">
            @include('Frontend.pages.Frontend_Page.second_MenuEN')
        </div>
        <div class="row h-80">
            @include('Frontend.pages.Frontend_Page.top_imageEN')
        </div>
        <div class="row">
            @include('Frontend.pages.Frontend_Page.statisticsEN')
        </div>

        <div class="row">
            <div class="container-fluid">
                @include('Frontend.pages.Frontend_Page.kurzyEN')
            </div>
        </div>
        <div class="row">
            <div class="container-fluid bg-blue newsletter-div">
                @include('Frontend.pages.Frontend_Page.newsletterEN')
            </div>
        </div>
        <div class="row">
            <div class="container-fluid">
                @include('Frontend.pages.Frontend_Page.aktualityEN')
            </div>
        </div>
        <div class="row">
            <div class="container-fluid bg-blue contact-section">
                @include('Frontend.pages.Frontend_Page.contact_UsEN')
            </div>
        </div>
        <div class="row">
