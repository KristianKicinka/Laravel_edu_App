...
<ul class="pl-4 call-buttons-list">
    <li class="py-2"><button data-toggle="modal" data-target="#startCallModal" id="video-call-btn" onclick="this.setState({ hasMedia:false})" type="button" class="btn btn-orange btn-circle btn-xl"><i class="fas fa-video"></i></button></li>
